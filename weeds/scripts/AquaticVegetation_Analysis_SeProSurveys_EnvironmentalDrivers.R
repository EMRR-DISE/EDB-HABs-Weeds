...
wq <- read_csv("./weeds/data_output/frk_sonde_data_summary.csv")
...
veg <- read_csv("./weeds/data_output/FranksTractManagement_2014-2021_formatted.csv")
...
#write_csv(outex,"./weeds/data_output/sepro_env_driver_corrs.csv")
...
sfigure <- ggarrange(nc, np, cs,ep,
                     #labels = c("A", "B"),
                     ncol = 2, nrow = 2)
#ggsave(plot=sfigure, "./weeds/plots/Sepro_Driver_SignCorrPanel.png",type ="cairo-png",width=8, height=8,units="in",dpi=300)
